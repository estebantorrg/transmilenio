...
import { addTroncalRoutesLayer, addZonalRoutesLayer, toggleTroncalRoutes, toggleZonalRoutes, highlightRoute, clearHighlight, } from './layers/routes';
...
function buildRouteList(troncalRoutes, zonalRoutes) {
    const troncalItems = troncalRoutes.map((r) => ({
    ...
    const zonalItems = zonalRoutes.map((r) => ({
