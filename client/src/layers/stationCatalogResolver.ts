...
// Avenida Jiménez (TM0013) and Ricaurte (TM0069) are physically TWO separate
// stations each — a Caracas/NQS trunk platform and a Calle 13 platform. The
// official app files each pair under ONE merged stop code, but ArcGIS exposes
// each platform as its own point. These entries split the merged catalog stop
// back into its platforms by wagon, so the map shows both stations distinctly.
// Wagon partitions verified against the live catalog (TM0013: A,B,C,D,E;
// TM0069: A,B,C,D,E,F).
