...
import type { TroncalRouteFeature, ZonalRouteFeature } from '../types/transmilenio';
...
export function markClickHandled(_e: maplibregl.MapMouseEvent): void {
...
export function addTroncalRoutesLayer(
  ...
  map.on('click', 'troncal-routes-line', (e) => {
    if (hasHigherPriorityFeature(map, e)) return;
